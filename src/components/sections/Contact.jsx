...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then((result) => {
        alert("Message Sent!");
        sentFormData({ name: "", email: "", message: "" });
      })
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="relative">
              <input
                ...
                placeholder="Name..."
                onChange={(e) =>
                  sentFormData({ ...formData, name: e.target.value })
                }
              />
            </div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  sentFormData({ ...formData, email: e.target.value })
                }
              />
            </div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  sentFormData({ ...formData, message: e.target.value })
                }
              />
            </div>
            <button
